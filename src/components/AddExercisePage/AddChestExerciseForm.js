...
class addChestExerciseForm extends Component {
  state = {
    exerciseName: '',
    exerciseDescription: '',
  ...
  render() {
    ...
    return(
      ...
      <section id="add-chest-exercise-section">
        <form className="add-exercise-form" onSubmit={this.addExercise}>
          <h4>Add Chest Exercise</h4>
...
export default connect(mapStoreToProps)(addChestExerciseForm);